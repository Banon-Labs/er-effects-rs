...
pub(crate) fn write_oracle_telemetry(body: &mut String) {
    ...
    body.push_str(&format!(
        ...
        format_optional_ptr(RESULT_EVENT_LAST_WORD0.load(Ordering::SeqCst)),
        format_optional_ptr(RESULT_EVENT_LAST_WORD1.load(Ordering::SeqCst)),

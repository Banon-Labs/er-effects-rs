...
pub(crate) fn write_oracle_telemetry(body: &mut String) {
    ...
    if let Ok(base) = crate::experiments::game_module_base() {
        ...
        let title_custom_cover_logo_remap_calls =
            TITLE_CUSTOM_COVER_LOGO_REMAP_CALLS.load(Ordering::SeqCst);
        let title_custom_cover_logo_remap_last_dialog =
            TITLE_CUSTOM_COVER_LOGO_REMAP_LAST_DIALOG.load(Ordering::SeqCst);
        let title_custom_cover_logo_remap_last_logo =
            TITLE_CUSTOM_COVER_LOGO_REMAP_LAST_LOGO.load(Ordering::SeqCst);
        let title_custom_cover_logo_remap_last_field =
            TITLE_CUSTOM_COVER_LOGO_REMAP_LAST_FIELD.load(Ordering::SeqCst);
        let title_profile_cover_bound_to_logo_surface = title_custom_cover_logo_remap_calls != 0;
        ...
        let title_custom_cover_profile_scene_generate_calls =
            TITLE_CUSTOM_COVER_PROFILE_SCENE_GENERATE_CALLS.load(Ordering::SeqCst);
        let title_custom_cover_profile_scene_generate_last_slot0_before =
            TITLE_CUSTOM_COVER_PROFILE_SCENE_GENERATE_LAST_SLOT0_BEFORE.load(Ordering::SeqCst);
        let title_custom_cover_profile_scene_generate_last_slot0_after =
            TITLE_CUSTOM_COVER_PROFILE_SCENE_GENERATE_LAST_SLOT0_AFTER.load(Ordering::SeqCst);
        let title_custom_cover_profile_scene_generate_nonnull_after =
            TITLE_CUSTOM_COVER_PROFILE_SCENE_GENERATE_NONNULL_AFTER.load(Ordering::SeqCst);
        ...
        body.push_str(&format!(
            ...
            title_custom_cover_logo_remap_calls,
            title_custom_cover_logo_remap_last_dialog,
            title_custom_cover_logo_remap_last_logo,
            title_custom_cover_logo_remap_last_field,
            title_logo_profile_summary,
            title_logo_profile_summary_ready,
            title_custom_cover_profile_scene_generate_calls,
            title_custom_cover_profile_scene_generate_last_slot0_before,
            title_custom_cover_profile_scene_generate_last_slot0_after,
            title_custom_cover_profile_scene_generate_nonnull_after,

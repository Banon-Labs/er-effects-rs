...
pub(crate) unsafe fn scan_dialog_for_continue(owner: usize, base: usize) -> Option<usize> {
    const NULL: usize = TITLE_OWNER_SCAN_START_ADDRESS;
...
pub(crate) unsafe fn title_menu_continue_action_ready(
    owner: usize,
    base: usize,
) -> Option<MenuActionNode> {
    let null = TITLE_OWNER_SCAN_START_ADDRESS;
...
pub(crate) fn native_continue_target_slot() -> Option<i32> {
...
pub(crate) unsafe fn native_continue_tick(owner: usize, base: usize, n: u64) {
    const NULL: usize = TITLE_OWNER_SCAN_START_ADDRESS;

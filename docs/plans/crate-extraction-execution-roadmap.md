...
|---|---:|---|
| `startup_hooks/quit_menu/save_swap_profile_table.rs` | 1,406 | dead-counter census |
...
| `startup_hooks/quit_menu/save_swap_profile_table.rs` | 1,406 | product profile renderer and quit swap families | R18-R19 |
...
| `startup_hooks/quit_menu/system_quit_ownership_repro.rs` | 1,462 | ownership, telemetry, quit, and portrait families | R19 |
| `startup_hooks/quit_menu/system_quit_repro_guards.rs` | 725 | product repro guard and quit/title families | R2 and R19 |
...
| `trace/menu_trace_hooks.rs` | 2,099 | title reload and menu trace families | R6C, R21, and D4 |

...
| `startup_hooks/save_picker/save_picker_menu.rs` | 75 | dead-counter census |
...
| `startup_hooks/loading_cover/startup_modals_menu_cover.rs` | 1,280 | stale-RVA call-site closure |
| `lifecycle/task_tick.rs` | 440 | dead-counter census |
| `input_block.rs` | 1,652 | dead-counter census |
| `startup_hooks/diagnostics/system_quit_ownership_repro.rs` | 1,299 | dead-counter census |
...
| `gpu_readback/boot_progress.rs` | 2,804 | loading-bar, boot-cover, and product adapter families | R4-R5 |
...
| `lifecycle.rs` | 27 | S10 lifecycle facade | R20 |
...
| `lifecycle/task_tick.rs` | 440 | product recurring-task scheduling | `STAY` |
...
| `own_load/loaders/switch_reload.rs` | 769 | switch-reload adapter family | D5 |
...
| `startup_hooks/diagnostics/layout_global_hooks.rs` | 341 | mixed title, quit, and product diagnostics | R11 and R22 |
| `startup_hooks/diagnostics/mod.rs` | 29 | diagnostics module facade | `STAY` |
| `startup_hooks/loading_cover/loading_cover_save_slot.rs` | 1,051 | save parsing, portrait, quit, telemetry, and product adapter families | R14-R18 |
| `startup_hooks/loading_cover/mod.rs` | 77 | loading-cover module facade | R15-R16 |
| `startup_hooks/loading_cover/portrait_equip_oracle.rs` | 10 | portrait oracle family | R16 |
| `startup_hooks/loading_cover/profile_table_gfx_files.rs` | 1,066 | Scaleform resource and profile-table families | D2 and R24 |
| `startup_hooks/loading_cover/scaleform_descriptor_guard.rs` | 39 | Scaleform descriptor guard | R8 |
| `startup_hooks/loading_cover/startup_modals_menu_cover.rs` | 1,280 | title-flow and product modal families | R22 |
| `startup_hooks/loading_cover/title_resources_stats_text.rs` | 2,106 | Scaleform resource, title, and product families | R22 and R24 |
...
| `startup_hooks/quit_menu/mod.rs` | 45 | quit-menu module facade | R10-R20 |
| `startup_hooks/save_picker/profile_05_010_editor_runtime.rs` | 1,394 | R12B1-R12B5 families listed in section 4.2 | R12A-R12B5 |
...
| `startup_hooks/save_picker/save_picker_menu.rs` | 75 | native picker, destination, and row-builder families | R17-R19 |
...
| `lifecycle/save_game_flow_handlers.rs` | 420 | split out of `system_quit_dialog_handlers.rs`: the vanilla Save Game row's request/retract/close flow, read by `lifecycle/save_flow.rs` | R18-R20 |
...
| `startup_hooks/save_picker/save_picker_path_editor.rs` | 9 | R13B1-R13B4 families listed in section 4.3 | R13A-R13B4 |
| `startup_hooks/quit_menu/save_swap_profile_table.rs` | 566 | product profile renderer and quit swap families | R18-R19 |
| `startup_hooks/quit_menu/system_quit_dialog_handlers.rs` | 231 | System>Quit dialog implementation and picker adapter; the row TEXT layer moved to `er_quit_menu_core::row_text` | R10 and R18 |
...
| `startup_hooks/diagnostics/system_quit_ownership_repro.rs` | 1,299 | ownership, telemetry, quit, and portrait families | R19 |
| `startup_hooks/quit_menu/system_quit_repro_guards.rs` | 730 | product repro guard and quit/title families | R2 and R19 |
| `startup_hooks/save_picker/mod.rs` | 31 | save-picker module facade | R17 |

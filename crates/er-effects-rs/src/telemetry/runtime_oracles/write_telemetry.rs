...
pub(crate) fn write_telemetry(state: &EffectsState, player_available: bool) {
    ...
    body.push_str(&format!(
        ...
        crate::experiments::OWN_LOAD_CONTINUE_FIRED_MS.load(Ordering::SeqCst),
        crate::experiments::TFC_CONTINUE_FIRED_MS.load(Ordering::SeqCst),
        fmt_stream(

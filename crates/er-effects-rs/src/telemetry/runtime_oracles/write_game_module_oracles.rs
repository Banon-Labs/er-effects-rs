fn write_game_module_oracles(body: &mut String) {
    ...
    if let Ok(base) = crate::experiments::game_module_base() {
        ...
        push_json_usize(
            body,
            "oracle_native_overlay_content_frames",
            NATIVE_OVERLAY_CONTENT_FRAMES.load(Ordering::SeqCst),
        );
        push_json_usize(
            body,
        ...
        push_json_usize(
            body,
            "oracle_native_overlay_zorder_lift_hits",
            NATIVE_OVERLAY_ZORDER_LIFT_HITS.load(Ordering::SeqCst),
        );
        push_json_usize(
            body,
        ...
        push_json_usize(
            body,
            "oracle_native_overlay_pixel_probe_matches",
            NATIVE_OVERLAY_PIXEL_PROBE_MATCHES.load(Ordering::SeqCst),
        );
        push_json_usize(
            body,
            "oracle_native_overlay_pixel_probe_rgba",
            NATIVE_OVERLAY_PIXEL_PROBE_RGBA.load(Ordering::SeqCst),
        );
        push_json_usize(
            body,

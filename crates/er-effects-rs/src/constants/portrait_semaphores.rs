...
pub(crate) use er_telemetry::counters::LS_PORTRAIT_LAST_W;
pub(crate) use er_telemetry::counters::LS_PORTRAIT_LAST_H;
...
pub(crate) use er_telemetry::counters::LS_PORTRAIT_LAST_NEUTRAL_PCT;
...
pub(crate) use er_telemetry::counters::LS_PORTRAIT_TOO_SMALL_SEEN_VERSION;
/// Once-seen latch: a capture that is our neutral texture (Bug B). Stores the capture version at first
/// detection (0 == never seen).
pub(crate) use er_telemetry::counters::LS_PORTRAIT_NEUTRAL_LEAK_SEEN_VERSION;
...
pub(crate) use er_telemetry::counters::LS_PORTRAIT_REJECTED_PUBLISHES;
...
pub(crate) use er_telemetry::counters::LOADING_BG_REFORGE_VERSION;
pub(crate) use er_telemetry::counters::LOADING_BG_REFORGE_LOGGED;
...
pub(crate) use er_telemetry::counters::LOADING_BG_PORTRAIT_IS_CHECKER;
/// Read-back portrait dimensions packed as `(width << 16) | height`. 0 until captured. Exposed as
/// `oracle_loading_bg_portrait_gx_dims`.
pub(crate) use er_telemetry::counters::LOADING_BG_PORTRAIT_DIMS;
...
pub(crate) use er_telemetry::counters::LOADING_BG_PORTRAIT_FORMAT;
...
pub(crate) use er_telemetry::counters::PROFILE_CAM_FACE_YAW_LATCHED_MASK;
...
pub(crate) use er_telemetry::counters::PROFILE_RENDER_DRIVE_HITS;
...
pub(crate) use er_telemetry::counters::PROFILE_LOADSCREEN_REBUILT;
/// Count of post-Continue profile-table (re)builds for the loading-screen portrait (telemetry/sweep).
pub(crate) use er_telemetry::counters::PROFILE_LOADSCREEN_TABLE_BUILDS;
...
pub(crate) use er_telemetry::counters::PROFILE_LOADSCREEN_TABLE_OWNED;
...
pub(crate) use er_telemetry::counters::PROFILE_TARGET_KICKS;
...
pub(crate) use er_telemetry::counters::PROFILE_FOREIGN_MODELS_MAX;
...
pub(crate) use er_telemetry::counters::PROFILE_MULTI_MODEL_PUBLISH_SKIPS;
...
pub(crate) use er_telemetry::counters::PROFILE_TABLE_EMPTY_STREAK;
...
pub(crate) use er_telemetry::counters::PROFILE_TABLE_WAS_POPULATED;
...
pub(crate) use er_telemetry::counters::LOADING_BG_PORTRAIT_SPARED_RENDERER;
...
pub(crate) use er_telemetry::counters::PROFILE_SPARE_CANDIDATE;
...
pub(crate) use er_telemetry::counters::PROFILE_SPARE_CANDIDATE_MODEL;
pub(crate) static PROFILE_RENDERER_TEARDOWN_HOOK_ORIG: AtomicUsize =
    AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub(crate) use er_telemetry::counters::PROFILE_RENDERER_TEARDOWN_HOOK_INSTALLED;
...
pub(crate) static PROFILE_SELECT_TABLE_DIAG_ORIG: AtomicUsize =
    AtomicUsize::new(HOOK_ORIGINAL_UNSET);
pub(crate) use er_telemetry::counters::PROFILE_SELECT_TABLE_DIAG_INSTALLED;
pub(crate) use er_telemetry::counters::PROFILE_SELECT_TABLE_DIAG_LAST;
...
pub(crate) use er_telemetry::counters::PROFILE_SELECT_TABLE_REPAIR_COUNT;
...
pub(crate) use er_telemetry::counters::PROFILE_SELECT_TABLE_GUARD_SKIP_COUNT;
/// Distinct-state latch for the guard-skip log line (same keying idea as the diag latch).
pub(crate) use er_telemetry::counters::PROFILE_SELECT_TABLE_GUARD_SKIP_LAST;
pub(crate) use er_telemetry::counters::PROFILE_RENDERER_SPARE_HITS;
...
pub(crate) use er_telemetry::counters::PORTRAIT_HOLD_WAIT_TICKS;
...
pub(crate) use er_telemetry::counters::PROFILE_REFRESH_KICKED;
...
pub(crate) use er_telemetry::counters::PORTRAIT_RENDER_SEMAPHORE_STATE;
/// One-shot log latch so the semaphore's crash-log/debug line prints exactly once before the fault.
pub(crate) use er_telemetry::counters::PORTRAIT_RENDER_SEMAPHORE_LOGGED;
...
pub(crate) use er_telemetry::counters::PROFILE_SLOT_DUMP_MASK;
...
pub(crate) use er_telemetry::counters::PROFILE_FORCE_TICK_COUNTER;
...
pub(crate) use er_telemetry::counters::PROFILE_LOADSCREEN_FEED_TICKS;
...
pub(crate) use er_telemetry::counters::PROFILE_REAL_SLOT_KICK_LOGGED;
...
pub(crate) use er_telemetry::counters::PROFILE_SIZE_PATCHED;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_UPLOADS;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_RESOLVES;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_RESOLVE_FAILS;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_CACHED_IMG;
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_CACHED_HAL;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_ORPHAN_IMG;
/// Displayed-texture dims last written (`(w<<16)|h`), for the size/format oracle. `oracle_gfx_portrait_hal_dims`.
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_HAL_DIMS;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_LAST_ERROR;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_DEMOTE_CREDIT;
/// Presents of overlay-head draw SKIPPED because the in-movie head was live (proof the handoff engaged).
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_OVERLAY_YIELDS;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_FIRST_LOGGED;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_BAKED;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_BAKED_DISPLAYED;
/// One-shot log latch for the first post-capture RE-FORGE of the displayed rti with the baked head.
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_REFORGE_LOGGED;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_HEAD_MATCH_PCT;
/// 1 once a probe crossed the head-present threshold (head confirmed on the loading screen), else 0.
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_HEAD_ON_SCREEN;
/// Count of backbuffer head-probes performed (proves the oracle actually ran).
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_HEAD_PROBE_COUNT;
...
pub(crate) use er_telemetry::counters::GFX_PORTRAIT_HEAD_EVER;
...
pub(crate) use er_telemetry::counters::SEM_BB_READBACK;

...
pub(crate) use er_telemetry::counters::PROFILE_READBACK_SOME;
pub(crate) use er_telemetry::counters::PROFILE_READBACK_CHECKER;
...
pub(crate) use er_telemetry::counters::PROFILE_READBACK_DEFERRED_SOME;
pub(crate) use er_telemetry::counters::PROFILE_READBACK_DEFERRED_NONBLACK;
/// One-shot latch: dump a single checker frame (slot 103) to see what the non-published frames hold.
pub(crate) use er_telemetry::counters::PROFILE_CHECKER_DUMPED;
...
pub(crate) use er_telemetry::counters::PROFILE_PERFRAME_HOOK_INSTALLED;
pub(crate) use er_telemetry::counters::PROFILE_PERFRAME_HOOK_HITS;
...
pub(crate) use er_telemetry::counters::PORTRAIT_ANIM_BOUND_RENDERER;
pub(crate) use er_telemetry::counters::PORTRAIT_ANIM_BOUND_LOC;
...
pub(crate) use er_telemetry::counters::PORTRAIT_FACEDATA_NEQ_TICKS;
pub(crate) use er_telemetry::counters::PORTRAIT_DRIVE_TICKS;
...
pub(crate) use er_telemetry::counters::PORTRAIT_KICK_SLOT_KEY;
...
/// safe (754-only).
pub(crate) use er_telemetry::counters::PORTRAIT_KICK_RENDERER;
...
pub(crate) use er_telemetry::counters::PORTRAIT_LAST_CONFIRMED_SLOT;
...
pub(crate) use er_telemetry::counters::PORTRAIT_SLOT_FLIP_CANDIDATE;
pub(crate) use er_telemetry::counters::PORTRAIT_SLOT_FLIP_STREAK;
...
/// window-2+ behavior.
pub(crate) use er_telemetry::counters::DEPTH_KEY_CACHED;
pub(crate) use er_telemetry::counters::DEPTH_KEY_NOMASK;
pub(crate) use er_telemetry::counters::DEPTH_RB_INFLIGHT_SKIPS;
pub(crate) use er_telemetry::counters::DEPTH_RB_FIND_FAILS;
pub(crate) use er_telemetry::counters::DEPTH_RB_DIMS_MISMATCHES;
pub(crate) use er_telemetry::counters::DEPTH_RB_NOGAP;
...
pub(crate) use er_telemetry::counters::PORTRAIT_PUMP_BLOCK_R;
pub(crate) use er_telemetry::counters::PORTRAIT_PUMP_BLOCK_VTABLE;
pub(crate) use er_telemetry::counters::PORTRAIT_PUMP_BLOCK_OFF;
...
pub(crate) use er_telemetry::counters::PORTRAIT_PUMP_BLOCK_OFF_RESOURCE;
pub(crate) use er_telemetry::counters::PORTRAIT_PUMP_BLOCK_MULTI;
...
pub(crate) use er_telemetry::counters::PORTRAIT_ANIM_BIND_STATE;
pub(crate) use er_telemetry::counters::PORTRAIT_ANIM_BIND_ATTEMPTS;
/// The idle anim id that actually bound (0 until success). `oracle_portrait_anim_bound_id`.
pub(crate) use er_telemetry::counters::PORTRAIT_ANIM_BOUND_ID;
...
pub(crate) use er_telemetry::counters::PORTRAIT_ANIM_HANDLE_BEFORE;
/// renderer+0x96c after the last bind attempt. `oracle_portrait_anim_handle`.
pub(crate) use er_telemetry::counters::PORTRAIT_ANIM_HANDLE;
...
pub(crate) use er_telemetry::counters::PORTRAIT_ANIM_SENTINEL;
...
pub(crate) use er_telemetry::counters::PORTRAIT_MOTION_METRIC_LAST;
pub(crate) use er_telemetry::counters::PORTRAIT_MOTION_METRIC_MAX;
...
pub(crate) use er_telemetry::counters::PORTRAIT_LUMA_FLICKER_LAST;
pub(crate) use er_telemetry::counters::PORTRAIT_LUMA_FLICKER_MAX;
...
pub(crate) use er_telemetry::counters::PROFILE_DRAW_TASK_CTX;
...
pub(crate) use er_telemetry::counters::PROFILE_IN_OUR_DRIVE;
...
/// captured frame.
pub(crate) use er_telemetry::counters::PROFILE_RENDERER_TEARDOWN_FENCE;
/// Render-thread pump invocations skipped because the teardown fence was up (expect a handful per switch).
pub(crate) use er_telemetry::counters::PROFILE_DRIVE_FENCE_SKIPS;
...
pub(crate) use er_telemetry::counters::PROFILE_DRIVE_CLOTH_SKIPS;
...
pub(crate) use er_telemetry::counters::PROFILE_TEARDOWN_FENCE_WAITS;
...
pub(crate) use er_telemetry::counters::PROFILE_TEARDOWN_FENCE_TIMEOUTS;
...
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_CLEAN_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_SKIPPED_TORN_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_SKIPPED_UNKEYED_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_MULTI_MODEL_PUBLISH_SKIPS_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_RT_PIN_SWITCHES_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_DRIVE_FENCE_SKIPS_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_COLOR_FROM_BUNDLE_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_COLOR_FROM_SCAN_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_DEPTH_FROM_CHAIN_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_DEPTH_FROM_BFS_WINDOW_MARK;
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_SKIPPED_UNPAIRED_WINDOW_MARK;
...
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_SKIPPED_LOWMASK;
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_SKIPPED_LOWMASK_WINDOW_MARK;
...
pub(crate) use er_telemetry::counters::PROFILE_WINDOW_FIRST_KEYED_DISPLAY;
pub(crate) use er_telemetry::counters::PROFILE_WINDOW_FIRST_KEYED_DISPLAY_LAST;
/// One-shot latch for the per-run ProfileSummary slot->character-name dump (hi2 attribution).
pub(crate) use er_telemetry::counters::PROFILE_SLOT_NAMES_DUMPED;
...
pub(crate) use er_telemetry::counters::PROFILE_READBACK_CHECKER_WINDOW_MARK;
...
pub(crate) use er_telemetry::counters::PROFILE_TEAR_EMA;
...
pub(crate) use er_telemetry::counters::PROFILE_ALPHA0_CLEARS;
/// One-shot latch for the model node-array enumerator (backdrop-part identification).
pub(crate) use er_telemetry::counters::PROFILE_MODEL_PARTS_DUMPED;
...
pub(crate) use er_telemetry::counters::PROFILE_DRAW_TASK_CTX_LOGGED;
...
pub(crate) use er_telemetry::counters::PROFILE_PERFRAME_MODEL_DRAWS;
...
pub(crate) use er_telemetry::counters::PROFILE_PERFRAME_SPARED_DRAWS;
pub(crate) use er_telemetry::counters::PROFILE_SPARED_MODEL_OK;
...
pub(crate) use er_telemetry::counters::PROFILE_GX_QUEUE_SAMPLES;
pub(crate) use er_telemetry::counters::PROFILE_GX_QUEUE_NONEMPTY;
...
pub(crate) use er_telemetry::counters::PROFILE_GX_POOL_FREE_MIN;
/// Most-recent free-depth sample (diagnostic).
pub(crate) use er_telemetry::counters::PROFILE_GX_POOL_FREE_LAST;
/// Raw `+0x110` used-mask (popcount == N, the allocated subcontext count). Tells us the headroom under 32.
pub(crate) use er_telemetry::counters::PROFILE_GX_POOL_USED_MASK;
...
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_YAW_BITS;
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_PITCH_BITS;
...
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_HOOK_INSTALLED;
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_HOOK_HITS;
...
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_RENDER_DRIVES;
...
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_REALTIME;
...
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_PHASE_DIAG_COUNTER;
...
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_RT_RGB_MAX;
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_RT_ALPHA_MAX;
...
pub(crate) use er_telemetry::counters::PROFILE_RT_CONTENT_DUMPED;
pub(crate) use er_telemetry::counters::PROFILE_SRV_DUMPED;
...
pub(crate) use er_telemetry::counters::PROFILE_RT_SRV_COPIES;
...
pub(crate) use er_telemetry::counters::PROFILE_RT_SRV_COPIES_WINDOW;
...
pub(crate) use er_telemetry::counters::PORTRAIT_RB_COUNT;
pub(crate) use er_telemetry::counters::PORTRAIT_RB_WAIT_US_SUM;
pub(crate) use er_telemetry::counters::PORTRAIT_RB_DESWIZZLE_US_SUM;
pub(crate) use er_telemetry::counters::PORTRAIT_RB_MASK_US_SUM;
pub(crate) use er_telemetry::counters::PORTRAIT_RB_MASK_COUNT;
...
pub(crate) use er_telemetry::counters::PORTRAIT_PIPELINE_GEN;
/// One-shot guard for the RT/SRV resource-identity diagnostic log.
pub(crate) use er_telemetry::counters::PROFILE_RT_SRV_COPY_DIAGGED;
/// One-shot guard for dumping the excluding-SRV content texture (slot 102) for visual inspection.
pub(crate) use er_telemetry::counters::PROFILE_CONTENT_EXCL_DUMPED;
...
pub(crate) use er_telemetry::counters::PROFILE_BAKE_RGBA_CAPTURED;
...
pub(crate) use er_telemetry::counters::PROFILE_HAVE_KEYED_FRAME;
...
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_SKIPPED_UNKEYED;
pub(crate) use er_telemetry::counters::PROFILE_PORTRAIT_RETARGETS;
...
pub(crate) use er_telemetry::counters::PROFILE_TEAR_SCORE_LAST;
pub(crate) use er_telemetry::counters::PROFILE_TEAR_SCORE_MAX;
pub(crate) use er_telemetry::counters::PROFILE_TEAR_SCORE_CLEAN_MIN;
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_SKIPPED_TORN;
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_CLEAN;
...
pub(crate) use er_telemetry::counters::PORTRAIT_WINDOW_PUBLISH_FAILURES;
...
pub(crate) use er_telemetry::counters::PORTRAIT_WINDOW_PUBLISH_FAIL_CAUSE;
...
pub(crate) use er_telemetry::counters::PROFILE_PUBLISH_CLEAN_WINDOW;
/// Per-window one-shot latch so the fast-fail trips PORTRAIT_WINDOW_PUBLISH_FAILURES exactly once.
pub(crate) use er_telemetry::counters::PORTRAIT_WINDOW_PUBLISH_FAIL_LATCHED;
...
pub(crate) use er_telemetry::counters::PORTRAIT_LAST_SKIP_CLASS;
...
pub(crate) use er_telemetry::counters::PROFILE_DRIVE_FRAMES_WINDOW;
...
pub(crate) use er_telemetry::counters::PROFILE_LOOKAT_RT_LASTHASH;
...
/// once thereafter.
pub(crate) use er_telemetry::counters::PORTRAIT_RENDER_WINDOW_DONE;

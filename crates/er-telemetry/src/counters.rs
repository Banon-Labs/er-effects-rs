...
pub static PROFILE_LOOKAT_LAST_CURSOR: AtomicUsize = AtomicUsize::new(0);
pub static PROFILE_LOOKAT_BONES_DUMPED_MASK: AtomicUsize = AtomicUsize::new(0);
pub static PROFILE_LOOKAT_TRACK_BUCKETS: AtomicUsize = AtomicUsize::new(0);
...
pub static PROFILE_CURSOR_SWEEP_ON: AtomicBool = AtomicBool::new(false);
pub static PROFILE_CURSOR_SWEEP_FIRST_WARP: AtomicBool = AtomicBool::new(false);

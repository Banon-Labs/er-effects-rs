...
cleanup() {
  ...
  # save.json reflects the POST-RESTORE state (the game autosaves mid-run; save-safety = the live
  # .sl2 is byte-identical after the run's backup/restore). Written here, after the restore.

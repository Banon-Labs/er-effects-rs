...
- **north_star_score** (unitless, higher is better):
  ...
  - 950: selected Seamless/ER save slot loads to `player_available=true` repeatably with deterministic in-process safe-input assistance; lower simulated-button counts are better and 0 remains the ideal.

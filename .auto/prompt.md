...
- Dead ends: host key/focus diagnostics worked but are not keepable; PostMessage-only, keybd_event, SendInput, GetAsyncKeyState/GetKeyState-only, and 8 early DirectInput pulses did not reach player availability. Do not retry them unchanged.

...
def oracle_summary(
    ...
    observed = {
        ...
        "result_event_last_code": telemetry.get("oracle_result_event_last_code"),
        "result_event_last_payload": telemetry.get("oracle_result_event_last_payload"),
        "result_action_last_event": telemetry.get("oracle_result_action_last_event"),
        "result_action_last_code": telemetry.get("oracle_result_action_last_code"),
        "result_action_last_payload": telemetry.get("oracle_result_action_last_payload"),

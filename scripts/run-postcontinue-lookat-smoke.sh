...
export ARTIFACT_DIR
# Clean the previous run's loading-screen-portrait capture artifacts: maybe_capture_loading_screen_portrait() returns
...
rm -f "$ARTIFACT_DIR"/loading-screen-portrait-screenshot.jpg \
      "$ARTIFACT_DIR"/loading-screen-portrait-screenshot.txt \
      "$ARTIFACT_DIR"/loading-screen-portrait-screenshot-event.json \
      "$ARTIFACT_DIR"/loading-screen-portrait-screenshot-analysis.json 2>/dev/null || true
